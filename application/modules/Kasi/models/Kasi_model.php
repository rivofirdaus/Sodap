...
class Kasi_model extends CI_Model
{
    ...
    {
        $this->datatables->select('idpptk,nmkegunit,nilai');
        $this->datatables->from($this->vtable_kasi);
        $this->datatables->where('idpnspptk', $id);
        $this->datatables->add_column('aksi', anchor(site_url('Kasi/detail/$1'), '<button class="btn1 btn btn-default btn-xs btn-block" ><i class="glyphicon glyphicon-eye-open"></i> Target Keuangan</button>'), 'idpptk');
		 $this->datatables->add_column('aksi2', anchor(site_url('Kasi/fisik/$1'), '<button class="btn1 btn btn-default btn-xs btn-block" ><i class="glyphicon glyphicon-eye-open"></i> Target Fisik</button>'), 'idpptk');
		  $this->datatables->add_column('aksi3', anchor(site_url('Kasi/realisasi/$1'), '<button class="btn1 btn btn-default btn-xs btn-block" ><i class="glyphicon glyphicon-eye-open"></i> Realisasi</button>'), 'idpptk');
