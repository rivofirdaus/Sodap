...
$config['kasubag_group']           	  = 'kasubag';  
$config['kasi_group']            	  = 'kasi';
$config['identity']                   = 'username';            
$config['identity_email']             = 'email';       // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
